...
<script type="text/javascript" src="<?php echo "https://cdn.jsdelivr.net/gh/Makiras/Makiras-Static/smarty_hankin"; ?>/assets/js/menu-setting.min.js"></script>
<?php endif;?>
<script type="text/javascript" src="<?php echo "https://cdn.jsdelivr.net/gh/Makiras/Makiras-Static/smarty_hankin"; ?>/assets/js/plugins/pjax.js"></script>
...
<script type="text/javascript" src="<?php echo "https://cdn.jsdelivr.net/gh/Makiras/Makiras-Static/smarty_hankin"; ?>/assets/js/wxShare.js"></script>
<!-- viewer start-->
<link rel="stylesheet" href="<?php echo "https://cdn.jsdelivr.net/gh/Makiras/Makiras-Static/smarty_hankin"; ?>/assets/viewer/viewer.min.css">
<script type="text/javascript" src="<?php echo "https://cdn.jsdelivr.net/gh/Makiras/Makiras-Static/smarty_hankin"; ?>/assets/viewer/viewer.min.js"></script>
<!-- viewer start-->
<script type="text/javascript" src="<?php echo "https://cdn.jsdelivr.net/gh/Makiras/Makiras-Static/smarty_hankin"; ?>/assets/js/main.js"></script>
<script type="text/javascript" src="<?php echo "https://cdn.jsdelivr.net/gh/Makiras/Makiras-Static/smarty_hankin"; ?>/assets/js/message.js"></script>
<?php if( ! empty( $i_js ) ){ echo '<script type="text/javascript">'.$i_js.'</script>';}else{ echo'';} ?>
<!-- 分享插件 start-->
<div id="cz-leftside-share"></div>
<script type="text/javascript" src="<?php echo "https://cdn.jsdelivr.net/gh/Makiras/Makiras-Static/smarty_hankin"; ?>/assets/js/plugins/jquery.share.min.js"></script>
<!-- 分享插件 end-->
...
<link rel="stylesheet" type="text/css" href="<?php echo "https://cdn.jsdelivr.net/gh/Makiras/Makiras-Static/smarty_hankin"; ?>/assets/player/css/play.css">
