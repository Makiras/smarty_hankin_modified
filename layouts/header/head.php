...
<link rel="stylesheet" href="<?php echo "https://cdn.jsdelivr.net/gh/Makiras/Makiras-Static/smarty_hankin"; ?>/assets/css/style.css">
<link rel="stylesheet" href="<?php echo "https://cdn.jsdelivr.net/gh/Makiras/Makiras-Static/smarty_hankin"; ?>/assets/css/main.css">
<link rel="stylesheet" href="<?php echo "https://cdn.jsdelivr.net/gh/Makiras/Makiras-Static/smarty_hankin"; ?>/assets/css/monokai_sublime.min.css">
...
<?php else:?>
	<link rel="stylesheet" class="layout-blur-css" id="layout-blur-css" href="<?= isset($i_theme_blur_layouts) ? "https://cdn.jsdelivr.net/gh/Makiras/Makiras-Static/smarty_hankin".'/assets/css/layout-blur-css.css' : ''?>">
<?php endif;?>
